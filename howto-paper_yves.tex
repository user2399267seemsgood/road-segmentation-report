...
\begin{figure*}[t]
	...
	{\includegraphics[width=0.32\linewidth]{pics/original.png}}
	\hspace{0.025\linewidth}
	\subfloat[mean-shift filtered \label{fig:mean-shift-filtered}]
	{\includegraphics[width=0.32\linewidth]{pics/mean_shifted.png}}
...
\begin{figure*}[tp]
	...
	{\includegraphics[width=0.23\linewidth]{pics/edge_detection.png}}
	\hspace{0.025\linewidth}
	\addtocounter{subfigure}{+1}
	\subfloat[thinned skeleton\label{fig:skeleton}]
	{\includegraphics[width=0.23\linewidth]{pics/skeleton.png}}
	\hspace{0.025\linewidth}
	\addtocounter{subfigure}{+1}
	\subfloat[final skeleton\label{fig:skeleton_final}]
	{\includegraphics[width=0.23\linewidth]{pics/skeleton_final}}
	\hspace{0.025\linewidth}
	\addtocounter{subfigure}{-4}
	\subfloat[distance map\label{fig:distance_map}]
	{\includegraphics[width=0.23\linewidth]{pics/distance_map.png}}
	\hspace{0.025\linewidth}
	\addtocounter{subfigure}{+1}
	\subfloat[pruned skeleton\label{fig:skeleton_pruned}]
	{\includegraphics[width=0.23\linewidth]{pics/skeleton_pruned.png}}
	\hspace{0.025\linewidth}
	\addtocounter{subfigure}{+1}
	\subfloat[region map]
	{\includegraphics[width=0.23\linewidth]{pics/color_map}}
